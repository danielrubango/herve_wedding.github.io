...
"# herve_wedding.github.io"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/danielrubango/herve_wedding.github.io.git git push -u origin master
